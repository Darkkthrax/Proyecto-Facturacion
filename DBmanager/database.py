...
def crear_db(root):
    try:
        ...
        with sqlite3.connect("db/database.db") as conn:
            cursor = conn.cursor()
            # Script para crear la base de datos en SQLite3
            sql_script = """
                ...
                INSERT INTO tbl_tipo_usuario (id_tipo, nombre) VALUES (0, "admin");
                INSERT INTO tbl_tipo_usuario (id_tipo, nombre) VALUES (1, "empleado");
                INSERT INTO tbl_tipo_usuario (id_tipo, nombre) VALUES (2, "cliente");
            """
    ...
    if os.path.exists("db/database.db"):
        try:
            with sqlite3.connect("db/database.db") as conn:
                ...
                cursor.execute("SELECT * FROM tbl_usuarios WHERE tipo_usuario = 0")
