...
def facturar_productos(root):
    ...
    buscador_codigo.bind("<FocusIn>", lambda event: on_focus_in(event, entry=buscador_codigo, placeholder="Agregar por código"))
    buscador_codigo.bind("<FocusOut>", lambda event: on_focus_out(event, entry=buscador_codigo, placeholder="Agregar por código"))
    ...
    buscador_nombre.bind("<FocusIn>", lambda event: on_focus_in(event, entry=buscador_nombre, placeholder="Agregar por nombre"))
    buscador_nombre.bind("<FocusOut>", lambda event: on_focus_out(event, entry=buscador_nombre, placeholder="Agregar por nombre"))
    ...
    cantidad_producto.bind("<FocusIn>", lambda event: on_focus_in(event, entry=cantidad_producto, placeholder="1"))
    cantidad_producto.bind("<FocusOut>", lambda event: on_focus_out(event, entry=cantidad_producto, placeholder="1"))
    ...
    buscador_cliente.bind("<FocusIn>", lambda event: on_focus_in(event, entry=buscador_cliente, placeholder="Documento de identidad"))
    buscador_cliente.bind("<FocusOut>", lambda event: on_focus_out(event, entry=buscador_cliente, placeholder="Documento de identidad"))
