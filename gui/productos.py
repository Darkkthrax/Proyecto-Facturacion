...
def editar_producto(root, tabla):
    ...
    input_nuevo_nombre.bind("<FocusIn>", lambda event: on_focus_in(event, entry=input_nuevo_nombre, placeholder=f"{info_producto_seleccionado[1]}"))
    input_nuevo_nombre.bind("<FocusOut>", lambda event: on_focus_out(event, entry=input_nuevo_nombre, placeholder=f"{info_producto_seleccionado[1]}"))
    ...
    input_nueva_descripcion.bind("<FocusIn>", lambda event: on_focus_in(event, entry=input_nueva_descripcion, placeholder=f"{info_producto_seleccionado[2]}"))
    input_nueva_descripcion.bind("<FocusOut>", lambda event: on_focus_out(event, entry=input_nueva_descripcion, placeholder=f"{info_producto_seleccionado[2]}"))
    ...
    input_nueva_cantidad.bind("<FocusIn>", lambda event: on_focus_in(event, entry=input_nueva_cantidad, placeholder=f"{info_producto_seleccionado[3]}"))
    input_nueva_cantidad.bind("<FocusOut>", lambda event: on_focus_out(event, entry=input_nueva_cantidad, placeholder=f"{info_producto_seleccionado[3]}"))
    ...
    input_nuevo_precio.bind("<FocusIn>", lambda event: on_focus_in(event, entry=input_nuevo_precio, placeholder=f"{info_producto_seleccionado[4]}"))
    input_nuevo_precio.bind("<FocusOut>", lambda event: on_focus_out(event, entry=input_nuevo_precio, placeholder=f"{info_producto_seleccionado[4]}"))
